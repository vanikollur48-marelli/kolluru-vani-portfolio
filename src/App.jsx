  ...
  return (
    <div className="App">
      ...
      <section id="about" className="about">
        ...
        <p>
          I am an Embedded Software Engineer with 4+ years of experience in
          AUTOSAR-based ECU software development, software integration, and
          validation for automotive systems. I have worked on Tata Sierra (EV &
          ICE) and Volkswagen MPCI Gateway ECU projects, with expertise in
          Embedded C, CAN, CANoe, UDS Diagnostics, and ASPICE-based
          development.
        </p>
      </section>
      ...
      <section id="skills" className="skills">
        ...
        <div className="skills-container">
          <div className="skill-card"><h3>AUTOSAR</h3></div>
          <div className="skill-card"><h3>Embedded C</h3></div>
          <div className="skill-card"><h3>CAN Communication</h3></div>
          <div className="skill-card"><h3>CANoe</h3></div>
          <div className="skill-card"><h3>Vector DaVinci</h3></div>
          <div className="skill-card"><h3>CAPL</h3></div>
          <div className="skill-card"><h3>Diagnostics (UDS)</h3></div>
          <div className="skill-card"><h3>Git</h3></div>
          <div className="skill-card"><h3>Linux</h3></div>
      ...
      <section id="projects" className="projects">
        ...
        <div className="project-card">
          ...
          <p>
            Developed AUTOSAR-based ECU software for automotive lighting and
            sensing systems.
          </p>
        </div>
        ...
        <div className="project-card">
          ...
          <p>
            Contributed to Gateway ECU development, software integration, MCAL
